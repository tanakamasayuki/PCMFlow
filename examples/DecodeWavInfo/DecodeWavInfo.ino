...
void setup()
{
    ...
    Serial.print("Codec: ");
    switch (audio.codec()) {
    case PCMFlow::CodecKind::Wav:  Serial.println("WAV");  break;
    case PCMFlow::CodecKind::Mp3:  Serial.println("MP3");  break;
    case PCMFlow::CodecKind::Flac: Serial.println("FLAC"); break;
    default: Serial.println("?"); break;
    }
    Serial.print("Source: ");
    Serial.print(audio.sourceFormat().sampleRate); Serial.print(" Hz, ");
    Serial.print(audio.sourceFormat().channels);   Serial.print(" ch, ");
    Serial.print(audio.sourceFormat().bitsPerSample); Serial.println("-bit");
    Serial.print("Output: ");
    Serial.print(audio.outputFormat().sampleRate); Serial.print(" Hz, ");
    Serial.print(audio.outputFormat().channels);   Serial.print(" ch, ");
    Serial.print(audio.outputFormat().bitsPerSample); Serial.println("-bit");
}
